package org.endeavourhealth.usermanagermodel;
...
public class PersistenceManager {
    ...
    private static synchronized void createEntityManager() throws Exception {
        ...
        JsonNode json = ConfigManager.getConfigurationAsJson("database", "user-manager");
        ...
        entityManagerFactory = Persistence.createEntityManagerFactory("UserManager", properties);
    }
}
