...
public class DataSharingSummaryEntity {
    ...
    public boolean equals(Object o) {
        ...
        org.endeavourhealth.informationmodel.api.database.models.DataSharingSummaryEntity that = (org.endeavourhealth.informationmodel.api.database.models.DataSharingSummaryEntity) o;
    ...
    public static List<org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity> getAllDataSharingSummaries() throws Exception {
        EntityManager entityManager = PersistenceManager.getEntityManager();

        CriteriaBuilder cb = entityManager.getCriteriaBuilder();
        CriteriaQuery<org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity> cq = cb.createQuery(org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity.class);
        Root<org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity> rootEntry = cq.from(org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity.class);
        CriteriaQuery<org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity> all = cq.select(rootEntry);
        TypedQuery<org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity> allQuery = entityManager.createQuery(all);
        List<org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity> ret = allQuery.getResultList();
    ...
    public static org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity getDataSharingSummary(String uuid) throws Exception {
        EntityManager entityManager = PersistenceManager.getEntityManager();

        org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity ret = entityManager.find(org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity.class, uuid);
    ...
    public static void updateDataSharingSummary(JsonDataSharingSummary dataSharingSummary) throws Exception {
        ...
        org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity dataSharingSummaryEntity = entityManager.find(org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity.class, dataSharingSummary.getUuid());
    ...
    public static void saveDataSharingSummary(JsonDataSharingSummary dataSharingSummary) throws Exception {
        ...
        org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity dataSharingSummaryEntity = new org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity();
        entityManager.getTransaction().begin();
        dataSharingSummaryEntity.setName(dataSharingSummary.getName());
        dataSharingSummaryEntity.setDescription(dataSharingSummary.getDescription());
        dataSharingSummaryEntity.setPurpose(dataSharingSummary.getPurpose());
    ...
    public static void deleteDataSharingSummary(String uuid) throws Exception {
        ...
        org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity dataSharingSummaryEntity = entityManager.find(org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity.class, uuid);
        entityManager.getTransaction().begin();
    ...
    public static List<org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity> search(String expression) throws Exception {
        EntityManager entityManager = PersistenceManager.getEntityManager();
        ...
        cq.where(predicate);
        TypedQuery<org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity> query = entityManager.createQuery(cq);
        List<org.endeavourhealth.core.mySQLDatabase.models.DataSharingSummaryEntity> ret = query.getResultList();
