...
public class DataProcessingAgreementEntity {
    ...
    public boolean equals(Object o) {
        ...
        org.endeavourhealth.informationmodel.api.database.models.DataProcessingAgreementEntity that = (org.endeavourhealth.informationmodel.api.database.models.DataProcessingAgreementEntity) o;
    ...
    public static List<org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity> getAllDPAs() throws Exception {
        EntityManager entityManager = PersistenceManager.getEntityManager();

        CriteriaBuilder cb = entityManager.getCriteriaBuilder();
        CriteriaQuery<org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity> cq = cb.createQuery(org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity.class);
        Root<org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity> rootEntry = cq.from(org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity.class);
        CriteriaQuery<org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity> all = cq.select(rootEntry);
        TypedQuery<org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity> allQuery = entityManager.createQuery(all);
        List<org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity> ret =  allQuery.getResultList();
    ...
    public static org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity getDPA(String uuid) throws Exception {
        EntityManager entityManager = PersistenceManager.getEntityManager();

        org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity ret = entityManager.find(org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity.class, uuid);
    ...
    public static void updateDPA(JsonDPA dpa) throws Exception {
        ...
        org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity dpaEntity = entityManager.find(org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity.class, dpa.getUuid());
    ...
    public static void saveDPA(JsonDPA dpa) throws Exception {
        ...
        org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity dpaEntity = new org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity();
        entityManager.getTransaction().begin();
        dpaEntity.setName(dpa.getName());
        dpaEntity.setName(dpa.getName());
        dpaEntity.setDescription(dpa.getDescription());
    ...
    public static void deleteDPA(String uuid) throws Exception {
        ...
        org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity dpaEntity = entityManager.find(org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity.class, uuid);
        entityManager.getTransaction().begin();
    ...
    public static List<org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity> search(String expression) throws Exception {
        EntityManager entityManager = PersistenceManager.getEntityManager();
        ...
        cq.where(predicate);
        TypedQuery<org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity> query = entityManager.createQuery(cq);
        List<org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity> ret = query.getResultList();
    ...
    public static List<org.endeavourhealth.core.mySQLDatabase.models.DataProcessingAgreementEntity> getDPAsFromList(List<String> dpas) throws Exception {
        EntityManager entityManager = PersistenceManager.getEntityManager();
